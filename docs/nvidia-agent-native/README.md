...
7. NeMo Retriever remains outside the Phase 1 core path; Phase 3A/B now owns its scoped integration Gate, which is currently blocked by the local Retriever HTTP 503.
